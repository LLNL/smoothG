...
int main(int argc, char* argv[])
{
    ...
    DirichletBCDarcyProblem fvproblem(*pmesh, ess_attr);
    ...
    rhs_fine.GetBlock(0) = fvproblem.GetEdgeRHS();
    rhs_fine.GetBlock(1) = fvproblem.GetVertexRHS();
