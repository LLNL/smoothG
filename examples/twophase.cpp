...
//    if (false)
    {
//        mfem::SparseMatrix fine_D = hierarchy_.GetMatrix(0).GetD();
//        fine_D *= (dt_ * density_);
//        fine_D.EliminateCols(hierarchy_.GetMatrix(0).GetEssDofs());
...
//        hierarchy_.Interpolate(1, blk_dx_print.GetBlock(2), for_print);
