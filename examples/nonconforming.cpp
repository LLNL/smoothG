...
//   Mesh *mesh = new Mesh(10, 10, mfem::Element::TRIANGLE, 1);
...
//      mesh->DegreeElevate(order, order);
   ...
   {
      fec = new CrouzeixRaviartFECollection();//H1_FECollection(order, dim);//
   ...
   a->AddInteriorFaceIntegrator(new DGElasticityIntegrator(lambda_func, mu_func, -1.0, 1.0));
